...
export default {
  ...
  'setup.hubTitle': 'What to configure',
  ...
  'setup.hintNone': 'same Wi-Fi / LAN only',
  'setup.hintCf': 'temporary URL, or a named tunnel on your own domain',
  'setup.hintCfNamed': 'your domain, stable HTTPS (most hands-off)',
  'setup.hintSsh': 'your own server / edge (tunlite)',
  'setup.hintNatapp': 'China-usable (needs a natapp authtoken)',
  'setup.hintCpolar': 'China-usable, auto-installs (needs a cpolar authtoken)',
  ...
  'setup.pushRegen': 'Regenerate VAPID keys',
  'setup.pushRegenerated': '✓ regenerated VAPID keys — existing phones must re-subscribe',
