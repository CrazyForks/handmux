...
export default {
  ...
  'setup.browserAbout': 'Enter a preview domain (for example, preview.example.com) and route its wildcard subdomains to Handmux over HTTPS; leave it blank for Direct mode only.',
