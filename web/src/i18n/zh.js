...
'chat.slash.handedOff': '已切到终端镜头 · 在这里操作 {cmd}',
  'chat.favs': '常用',
  'chat.tabMsg': '消息',
  ...
  'settings.chat_lens_hint': '实验性功能，可能不稳定。以对话形式查看和操作 Claude 会话；开启后，窗口栏出现镜头切换，并可选择对话配色。',
  'boot.loading': '正在加载',
  ...
  'settings.chat_tone_hint': '对话镜头的色调，均为暖色系。暖夜=暖棕暗、暖金=品牌橄榄金、暖黄=奶油亮。',
