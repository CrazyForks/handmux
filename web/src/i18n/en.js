...
export default {
  ...
  'browser.loadStalledTitle': 'Page may be unavailable',
  'browser.directLoadStalled': 'This page is taking too long to load. The site may block iframe embedding with CSP, or your phone network may not be able to reach it.',
  'browser.proxyLoadStalled': 'This page is taking too long to load. The computer network may not be able to reach it, or the site may be incompatible with proxy rewriting.',
  'browser.keepWaiting': 'Keep waiting',
  'browser.retry': 'Retry',
  ...
  'browser.consentLimits': 'Proxy access is usually slower and cannot guarantee every site will work. Direct mode may be blocked by a site’s iframe or CSP policy. Proxy mode supports WebSocket, but specialized security policies or browser capabilities may still be incompatible.',
  'browser.consentIdle': 'Background tabs close after 10 minutes by default. Direct-site cookies remain in your phone browser.',
  'browser.about': 'About the built-in browser',
  ...
  'browser.tryDirect': 'Try direct from phone',
  ...
  'browser.profileClearFailed': 'Cleanup was not fully successful. Tabs were refreshed from the server; check storage permissions and try again.',
...
'chat.slash.handedOff': 'Switched to terminal — run {cmd} there',
  ...
  'settings.chat_lens_hint': 'Experimental — may be unstable. View and drive Claude sessions as a chat; enables the view switch in the window bar and the chat colour tones below.',
  'settings.chat_lens_need_hooks': 'Requires Claude hooks first — question cards and status cues in the chat view depend on them.',
