...
export default {
  ...
  'browser.proxyLoginHelp': 'Not saved keeps proxy Cookies and sign-ins only for the current runtime. Choosing 1, 7, 30 days or long-term storage encrypts them for this device and clears them when the selected period expires. Direct-site Cookies are unaffected, and nothing is shared with other devices.',
  ...
  'settings.browserPersistLogin': 'Keep proxy login state',
