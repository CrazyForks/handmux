...
export default {
  ...
  'browser.consentBody': 'Handmux embeds pages in this window. It is not a full browser; use it to preview development servers, localhost, intranet sites, and websites that allow embedding.',
