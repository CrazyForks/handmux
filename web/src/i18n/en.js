...
export default {
  ...
  'browser.retry': 'Retry',
  'browser.consentTitle': 'This is Web Preview, not a full browser',
  'browser.consentBody': 'Handmux embeds pages in this window. It is designed for development servers, localhost, intranet sites, and websites that allow embedding.',
  ...
  'browser.consentLimits': 'Direct mode may be blocked by a site’s iframe or CSP policy, and Handmux may not be able to identify why. Computer proxy mode forwards and rewrites pages but cannot guarantee compatibility with every site. For full browsing, open the page in Safari, Chrome, or your system browser.',
