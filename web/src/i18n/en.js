...
'chat.slash.handedOff': 'Switched to terminal — run {cmd} there',
  ...
  'settings.terminal_transport_live': 'Real-time stream',
  'settings.terminal_transport_snapshot': 'Snapshot refresh',
  'settings.terminal_transport_hint': 'Real-time has lower latency and temporarily falls back to snapshots if the connection fails. You can also keep this browser on snapshot refresh.',
