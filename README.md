...
- **Client reload after updates** — once the server update has finished, use Settings → Version & Updates → Reload app to load the new client without quitting and reopening the home-screen app.
